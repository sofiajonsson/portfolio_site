		...
		return(
			...
			<br />
			 <p className="general-p-tag">
					...
					I discovered my passion for coding while seeking something to keep my mind stimulated after University.
					I am currently employed as an SDET and enjoy the challenge of learning and expanding my Java knowledge where I combine the skills of a QA and Developer to strategize and plan the automation of newly developed functionalities.
					Working as an SDET has allowed me to pick up new skills, alter my way of thinking, and value the time I get to spend coding. As I progress in my career, I look forward to taking on more complex solutions, leveraging modern test automation, and expanding my knowledge of open source frameworks. My background in business and hospitality graduate has allowed me to develop a skill set that centers on organization, communication, and thriving under pressure. I enjoy learning new things in a fast-paced environment and wish to move forward on this continuous learning path.
					<br/> <br/>
